...
| #     | Task                                                                                                         | Status | Depends On                 | Notes                               |
| ----- | ------------------------------------------------------------------------------------------------------------ | ------ | -------------------------- | ----------------------------------- |
| 3.5.1 | Build `<PlayPage>` — compose: `<UserSearchBar>`, `<PendingChallenges>`, "Create Quiz" button, `<FolderView>` | `[~]`  | 2.4.5, 3.1.3, 2.1.8, 2.2.4 | Main hub of the app. FolderView + Upload wired in |
